...
<TouchableNativeFeedback onPress={() => navigation.navigate('PerjalananDinasDalam')}>
<View style={{padding:10, backgroundColor:colors.white, borderRadius:5,flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
  ...
  <Text style={{fontFamily:fonts.primary[600], fontSize: MyDimensi/3.6, marginLeft:20}}>Perjalanan Dinas Dalam</Text>
</View>
...
<TouchableNativeFeedback onPress={() => navigation.navigate('PerjalananDinasLuar')}>
<View style={{padding:10, backgroundColor:colors.white, borderRadius:5,flexDirection:'row', justifyContent:'center', alignItems:'center'}}>
  <Image source={require('../../assets/icondinasluar.png')} style={{width:51, height:51, left: -20}}/>
  <Text style={{fontFamily:fonts.primary[600], fontSize: MyDimensi/3.6, marginLeft:0}}>Perjalanan Dinas Luar</Text>
</View>
</TouchableNativeFeedback>
</View>
